...
namespace WebApplication1.Controllers
{
    public class BuyersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("BuyerId,Surname,Name,Address,Telephone")] Buyer buyer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("BuyerId,Surname,Name,Address,Telephone")] Buyer buyer)
        {
            if (id != buyer.BuyerId)
            {
                return NotFound();
